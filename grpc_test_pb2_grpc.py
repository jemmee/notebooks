...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in grpc_test_pb2_grpc.py depends on'
...
class ProductServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.GetProductDetails = channel.unary_unary(
                ...
                request_serializer=grpc__test__pb2.ProductRequest.SerializeToString,
                response_deserializer=grpc__test__pb2.ProductResponse.FromString,
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetProductDetails': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=grpc__test__pb2.ProductRequest.FromString,
                    response_serializer=grpc__test__pb2.ProductResponse.SerializeToString,
            ),
    }
...
class ProductService:
    ...
    def GetProductDetails(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/product.ProductService/GetProductDetails',
            grpc__test__pb2.ProductRequest.SerializeToString,
            grpc__test__pb2.ProductResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
